...
const Navbar = () => {
  ...
  return (
    <div className="py-10 md:py-16 md:pb-5 navbar">
      <nav className="fixed inset-x-0 top-0 z-20 px-2 text-sm border-gray-200 bg-custom-blue">
        <div className="flex flex-wrap items-center justify-between py-1 mx-5 sm:mx-14">
          ...
          >
            ...
            <div className="flex flex-row items-start w-full lg:ml-auto lg:w-auto lg:h-auto">
              ...
              <Link
                to="/Register"
                className="items-center justify-center w-auto px-4 py-2 mb-3 ml-5 font-bold rounded text-custom-blue bg-custom-green lg:inline-flex hover:bg-custom-blue hover:text-custom-green hover:ring-2 hover:ring-custom-green"
              >
                Register
              </Link>
            </div>
